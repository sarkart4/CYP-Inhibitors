...
import sys
sys.path.append('/p/lustre3/fan4/atomCode')
...
#-------------------------------------------------------------------------------------
# Upload union files to datastore
#-------------------------------------------------------------------------------------
def upload_file_smiles_union(filename, title, description, response_col,tags,
                            functional_area, source_file_ID,
                           target, target_type, activity, assay_category,file_path,
                        smiles_column,  data_origin='journal',  species='human',
                           force_update=False):

    bucket = 'public'
    #filename = '%s_dtc_trainset_base_smiles_union.csv' % dset_name
